...
const INTENT_VALIDATORS: Readonly<Record<string, IntentValidator>> = {
  ...
  REACTOR_TUNE: validateReactorTune,
  REACTOR_RESTART: validateReactorRestart,
  ENGINE_TUNE: validateEngineTune,
  ENGINE_FUEL: validateEngineFuel,
