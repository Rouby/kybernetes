...
export const ROLE_DEFINITIONS: Record<StartingRole, RoleDefinition> = {
  wiper: {
    ...
    startingStationId: 'reactor_console',
  ...
  security_private: {
    ...
    startingStationId: 'armory_sentry',
  ...
  hydro_tender: {
    ...
    startingStationId: 'hydro_scrubber',
    startingDeckId: 'deck_b',
